...
export async function PUT(req, res) {
  const { result, memo, talk_memo, status, target_seq, user_seq, call_result_seq } = await req.json();
  ...
  if( result === "자료요청" ) {
    ...
    await execQuery(`INSERT INTO talk_result (target_seq, call_user_seq, status, talk_user_seq, memo, create_date, update_date) VALUES ('${target_seq}', '${user_seq}', '${status}', ${talkUserSeq}, ${talk_memo}, NOW(), NOW())`);
  }
